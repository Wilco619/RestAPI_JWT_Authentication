...
from .views import CustomUserViewSet, AdminUserViewSet, CustomerCountView, CustomerDetailView, CustomerListView, PasswordChangeView, RmanagerViewSet, StaffUserViewSet, UserInfoAPIView, UserLogOutAPIView
